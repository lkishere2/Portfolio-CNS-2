export default function ClosingSentence() {
  return (
    <div className="relative bg-gradient-to-br from-pink-50 to-rose-50 border border-pink-200 rounded-3xl p-8 text-center overflow-hidden mt-12">
      <div className="hidden md:block absolute -top-6 -right-6 w-24 h-24 bg-pink-200 rounded-full blur-2xl opacity-40" />
      <div className="hidden md:block absolute -bottom-6 -left-6 w-20 h-20 bg-rose-200 rounded-full blur-2xl opacity-30" />
      <blockquote className="relative text-gray-600 text-base italic leading-relaxed">
