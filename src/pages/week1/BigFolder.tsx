  ...
  return (
    <div className="relative w-full max-w-sm mx-auto aspect-[4/3] flex items-center justify-center perspective-[1500px]">
      ...
      <div className="relative w-[90%] h-[80%] transition-transform duration-1000 ease-out preserve-3d" 
        ...
        {/* Paper 1 */}
        <div className="absolute w-[85%] h-[95%] bottom-2 left-1/2 -translate-x-1/2 bg-white rounded shadow-md flex flex-col gap-3 p-4 opacity-0 animate-paper-slide-1 will-change-transform transform-gpu" 
        ...
        {/* Paper 2 */}
        <div className="absolute w-[92%] h-[88%] bottom-1 left-1/2 -translate-x-1/2 bg-yellow-50 rounded shadow-lg flex flex-col gap-3 p-4 opacity-0 animate-paper-slide-2 border border-yellow-100 will-change-transform transform-gpu" 
        ...
        <div 
          className="absolute inset-0 bg-gradient-to-tr from-yellow-500 to-yellow-400 rounded-lg shadow-[0_10px_20px_rgba(0,0,0,0.2)] flex flex-col justify-end p-5 border-t border-yellow-300 origin-bottom animate-folder-flap-open will-change-transform transform-gpu"
          style={{ transform: 'translateZ(10px)' }}
        >
